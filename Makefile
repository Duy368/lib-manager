...
SRC_DIRS += $(PROJECT_DIR)/book
SRC_DIRS += $(PROJECT_DIR)/lib
SRC_DIRS += $(PROJECT_DIR)/storage
SRC_DIRS += $(PROJECT_DIR)/user
SRC_DIRS += $(PROJECT_DIR)/error
...
# include directory
INC_DIRS = $(PROJECT_DIR)/book
INC_DIRS += $(PROJECT_DIR)/error
INC_DIRS += $(PROJECT_DIR)/lib
INC_DIRS += $(PROJECT_DIR)/storage
INC_DIRS += $(PROJECT_DIR)/user
